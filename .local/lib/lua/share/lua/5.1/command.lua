...
-- this is a mimic of the pipe (|) operator from the posix shell
...
-- fork and execute
-- this is my best try to mimic the ampersand (&) operator from the posix shell
function M.exec(bin, args, opts)
    opts = opts or {}
